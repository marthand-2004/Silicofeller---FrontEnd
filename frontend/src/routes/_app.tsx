...
import { LogOut, Settings as SettingsIcon, User as UserIcon, CreditCard, Bell, Search } from "lucide-react";
          ...
          <SidebarInset className="flex flex-1 flex-col overflow-hidden">
            ...
            <header className="sticky top-0 z-30 flex h-12 items-center justify-between border-b border-slate-200/50 bg-white/70 px-4 backdrop-blur-md shadow-[0_1px_2px_0_rgba(0,0,0,0.01)] select-none">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-sm font-black text-slate-900 tracking-tight font-display">{getPageTitle()}</h1>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-52 mt-1 rounded-2xl border-slate-200 shadow-xl p-1 bg-white">
                    <DropdownMenuLabel className="px-3 py-2">
                      <div className="flex flex-col">
                        <span className="font-extrabold text-slate-900 leading-tight">{user.name}</span>
                        <span className="text-[9px] text-slate-400 font-semibold mt-0.5">{user.email}</span>
                      </div>
                    </DropdownMenuLabel>
