...
|------|-----|------|-------------|
| `__root.tsx` | *(all)* | — | App shell: `QueryClientProvider`, `AuthProvider`, `Toaster` |
...
2. **`../components/app/app-sidebar.tsx`** — A **"QBETA Chatbot"** entry under the *Tools* group in the sidebar
