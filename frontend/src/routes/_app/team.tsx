...
function TeamPage() {
  ...
  const [members, setMembers] = useState<Member[]>([
    { id: "m1", name: "Eli Novak", email: "engineer@quantumlabs.com", role: "Engineer", initials: "EN" },
    { id: "m2", name: "Riley Kim", email: "riley@quantumlabs.com", role: "Engineer", initials: "RK" },
    { id: "m3", name: "Mira Chen", email: "manager@quantumlabs.com", role: "Organization Manager", initials: "MC" },
  ]);
  ...
  return (
    ...
    >
      <div className="mb-6 flex items-end justify-between gap-3">
        ...
        <Badge variant="secondary" className="rounded-full">{user.organization}</Badge>
      </div>

      <Card className="rounded-3xl border-border p-6 shadow-none">
        <div className="flex flex-wrap items-end gap-2">
          <div className="flex-1 min-w-[240px]">
            <label className="text-xs font-medium text-muted-foreground">Invite engineer by email</label>
            <Input
              value={email}
